...
func (s *DocumentServiceSuite) SetupSuite() {
	...
	s.repo = repo.NewDocumentrepo(client, "testdb", "documentCollection")
}
...
func (s *DocumentServiceSuite) TestSearchDocuments() {
	...
	// Call the method under test
	documents, err := s.repo.SearchDocuments(email, searchQuery)
...
func (s *DocumentServiceSuite) TestUpdateDocument() {
	...
	// Call the method under test
	err = s.repo.UpdateDocument(documentID, incomingData)
...
func (s *DocumentServiceSuite) TestUpdateTitle() {
	...
	// Call the method under test
	updatedTitle, err := s.repo.UpdateTitle(documentID, newTitle)
...
func (s *DocumentServiceSuite) TestUpdateCollaborators() {
	...
	// Call the method under test
	updatedDocument, err := s.repo.UpdateCollaborators(documentID, newCollaborators)
...
func (s *DocumentServiceSuite) TestDeleteDocument() {
	...
	// Call the method under test
	deleted, err = s.repo.DeleteDocument(documentID)
	...
	deletedDocument, err := s.repo.GetDocumentByID(documentID)
	s.Error(err)
